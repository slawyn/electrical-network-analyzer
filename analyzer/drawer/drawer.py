...
from .elements import DrawElement
...
class NetworkDrawer():
    ...
    def __init__(self, network):
        ...
        self.image = Image.new("RGB", (int(NetworkDrawer.CANVAS_SIZE_X), int(
            NetworkDrawer.CANVAS_SIZE_Y)), color=NetworkDrawer.COLOR_BACKGROUND)
